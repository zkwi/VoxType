...
export const en = {
  ...
  "setupHealthCheckingDescription": "Checking ASR keys, microphone, and triggers. This should only take a moment.",
  ...
  "clipboardTextRestoreHint": "VoxType tries to restore plain text, common HTML/RTF rich text, and other copyable memory formats. Images and some private formats may still be unrecoverable and will show a warning.",
